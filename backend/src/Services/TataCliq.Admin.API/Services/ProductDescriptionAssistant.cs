...
/// in the admin CMS. The system prompt follows Tata CLiQ Fashion's luxury-tier
    ...
    ILogger<ProductDescriptionAssistant> logger) : IProductDescriptionAssistant
{
    private const string SystemPrompt =
        """
        You are a luxury fashion copywriter for Tata CLiQ Fashion, India's premium online fashion destination.
