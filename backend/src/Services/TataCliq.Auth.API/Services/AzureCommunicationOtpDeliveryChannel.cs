    ...
    ILogger<AzureCommunicationOtpDeliveryChannel> logger) : IOtpDeliveryChannel
{
    ...
    {
        var senderAddress = options.AzureCommunication?.SenderAddress ?? "donotreply@tatacliq.com";
        ...
        var subject = $"Your TataCLiQ {purposeLabel} Code";
        var content = new EmailContent(subject)
        {
            Html      = BuildHtml(code, purposeLabel),
            PlainText = $"Your TataCLiQ {purposeLabel} OTP is: {code}. Valid for 15 minutes. Do not share this code."
        };
            ...
            <tr><td align="center" style="padding:40px 20px">
              <table width="600" cellpadding="0" cellspacing="0"
                ...
                <tr><td style="background:#1C2B4A;padding:24px 32px">
                  <h1 style="margin:0;color:#FFFFFF;font-size:22px;font-weight:700">TataCLiQ</h1>
                </td></tr>
                ...
                <tr><td style="background:#F5F5F5;padding:16px 32px;text-align:center">
                  <p style="margin:0;color:#9E9E9E;font-size:11px">&copy; 2026 TataCLiQ Fashion. All rights reserved.</p>
                </td></tr>
              </table>
            </td></tr>
          </table>
