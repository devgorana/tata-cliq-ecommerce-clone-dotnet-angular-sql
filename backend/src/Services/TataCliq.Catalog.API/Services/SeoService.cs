 ...
 *   - Title template: "{Name} — Buy Online at Tata CLiQ" (product)
 *                     "Buy {Name} Online at Best Prices | Tata CLiQ" (category)
...
public sealed class SeoService(AppDbContext db) : ISeoService
{
        ...
        Guid productId, CancellationToken ct = default)
    {
        ...
        var autoTitle       = $"{product.Name} — Buy Online at Tata CLiQ";
        var brandName       = product.Brand?.Name ?? "Top Brands";
        var autoDescription = $"Shop {product.Name} from {brandName}. Get the best price and fast delivery at Tata CLiQ.";
        ...
        Guid categoryId, CancellationToken ct = default)
    {
        ...
        // Auto-generated templates
        var autoTitle       = $"Buy {category.Name} Online at Best Prices | Tata CLiQ";
        var autoDescription = $"Explore the widest range of {category.Name} products online. Shop with confidence at Tata CLiQ.";
