 ...
 *     12 calendar months, their entire CLiQ Cash balance is forfeited.
...
{
    /// <summary>
    /// ENH-PROMO-002 — Expires CLiQ Cash for a single user if they have been inactive
...
/// <summary>ENH-PROMO-002 — 12-month inactivity forfeiture for CLiQ Cash balances.</summary>
public sealed class WalletExpiryService(
    AppDbContext db,
    ILogger<WalletExpiryService> logger) : IWalletExpiryService
{
    /// <summary>
    /// The inactivity window after which a CLiQ Cash balance is forfeited.
        ...
        Guid userId, DateTime now, CancellationToken ct = default)
    {
        ...
        db.WalletTransactions.Add(new WalletTransaction
        {
            ...
            Description  = "CLiQ Cash expired due to 12-month inactivity",
        ...
        logger.LogInformation(
            ...
            "CLIQ_CASH_EXPIRED", userId, forfeitedAmount, wallet.LastPurchaseAt);
        ...
        DateTime now, CancellationToken ct = default)
    {
        ...
        logger.LogInformation(
            ...
            "CLIQ_CASH_EXPIRY_BATCH_COMPLETE", now, count);
