...
using SellerInventoryEntity = TataCliq.Infrastructure.Entities.Seller.SellerInventory;
using SellerEntity = TataCliq.Infrastructure.Entities.Seller.Seller;

namespace TataCliq.Admin.Tests;
